...
const getParamsWithWrongType = (oJsDocComment, aModuleArguments) => {
...
const reportJsDocParamTypeIsWrong = (
  context,
  oJsDocComment,
  ...
  _.forEach(aParamsWithWrongType, oParamWithWrongType => {
    context.report({
      ...
      fix: fixer => {
        const aReplacement = oJsDocComment.value.split("\n");
