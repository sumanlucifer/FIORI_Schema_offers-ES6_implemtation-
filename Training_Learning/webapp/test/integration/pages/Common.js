sap.ui.define([
	...
	return Opa5.extend("com.knpl.pragati.Training_Learning.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/knpl/pragati/Training_Learning/localService/mockserver"], function (mockserver) {
