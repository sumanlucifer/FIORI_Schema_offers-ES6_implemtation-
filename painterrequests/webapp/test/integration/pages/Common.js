sap.ui.define([
	...
	return Opa5.extend("com.knpl.pragati.painterrequests.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/knpl/pragati/painterrequests/localService/mockserver"], function (mockserver) {
