sap.ui.define([
    ...
    "com/knpl/pragati/painterrequests/model/cmbxDtype2",
    "com/knpl/pragati/painterrequests/controller/Validator",
    "sap/m/MessageBox",
    "sap/m/MessageToast"
        ...
        onValueHelpRequest: function (oEvent) {
            ...
            if (!this._pValueHelpDialog) {
                this._pValueHelpDialog = Fragment.load({
                    id: oView.getId(),
                    name:
                        "com.knpl.pragati.painterrequests.view.subview.ValueHelpDialog",
                    controller: this,
        ...
        onValueHelpSlabs: function (oEvent) {
            ...
            if (!this._sValueHelpDialog) {
                this._sValueHelpDialog = Fragment.load({
                    id: oView.getId(),
                    name:
                        "com.knpl.pragati.painterrequests.view.subview.ValueHelpDialogSlabs",
                    controller: this,
                }).then(function (oDialog) {
                    oView.addDependent(oDialog);
                    return oDialog;
