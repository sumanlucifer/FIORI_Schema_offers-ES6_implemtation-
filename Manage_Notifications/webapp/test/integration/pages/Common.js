sap.ui.define([
	...
	return Opa5.extend("com.knpl.pragati.Manage_Notifications.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/knpl/pragati/Manage_Notifications/localService/mockserver"], function (mockserver) {
