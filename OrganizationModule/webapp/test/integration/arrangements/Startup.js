sap.ui.define([
	"sap/ui/test/Opa5",
	"com/knpl/pragat/OrganizationModule/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.knpl.pragat.OrganizationModule.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.knpl.pragat.OrganizationModule",
					async: true
				},
				hash: oOptions.hash,
