            ...
            "com.knpl.pragati.redeempoints.controller.Worklist", {
                    ...
                    oModel.read("/MasterCompanySettingsSet(1)", {
                        success: function (oRetrievedResult) {
                            if (oRetrievedResult.IsRedemptionEnabled == true) {
                                ...
                                MessageBox.alert("Payments are disabled. You can not add/approve redemption request.");
                            }
                ...
                handleSortButtonPressed: function () {
                    this.getViewSettingsDialog(
                        "com.knpl.pragati.redeempoints.view.subview.SortDialog"
                ...
                onPressAdd: function (oEvent) {
                    var oModelControl = this.getView().getModel("oModelControl");
                    var IsRedemption = oModelControl.getProperty("/IsRedemption");
                    if (IsRedemption == false) {
                        MessageBox.alert("Payments are disabled. You can not add redemption request.");
