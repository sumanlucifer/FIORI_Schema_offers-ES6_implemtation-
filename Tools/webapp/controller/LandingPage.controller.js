...
function (BaseController, Filter, FilterOperator, JSONModel, Sorter, Fragment, Device, MessageBox, MessageToast, ColumnListItem, Label, Token) {
    ...
    return BaseController.extend("com.knpl.pragati.Tools.controller.LandingPage", {
        ...
        onValueHelpRequested: function() {
			...
			// @ts-ignore
			this._oValueHelpDialog = sap.ui.xmlfragment("com.knpl.pragati.Tools.view.fragment.CreatedByValueHelpDialog", this);
        ...
        handleSortButtonPressed: function () {
			this.getViewSettingsDialog("com.knpl.pragati.Tools.view.fragment.SortDialog")
