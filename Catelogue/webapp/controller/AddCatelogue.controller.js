sap.ui.define([
...
], function (BaseController,jQuery, deepExtend, syncStyleClass, Controller,
     ObjectMarker, MessageToast, UploadCollectionParameter, MobileLibrary, JSONModel,
	...
	return BaseController.extend("com.knpl.pragati.Catelogue.controller.AddCatelogue", {
        ...
        onInit : function (){
			...
			// set mock data
			var sPath = sap.ui.require.toUrl("knpl-influencer-web/Catelogue/webapp/model/demoData.json");
