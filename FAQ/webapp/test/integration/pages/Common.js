sap.ui.define([
	...
	return Opa5.extend("com.knpl.pragati.FAQ.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/knpl/pragati/FAQ/localService/mockserver"], function (mockserver) {
