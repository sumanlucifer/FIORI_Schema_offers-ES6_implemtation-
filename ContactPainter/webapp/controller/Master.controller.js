sap.ui.define([
	...
	return BaseController.extend("com.knpl.pragati.ContactPainter.controller.Master", {
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "com.knpl.pragati.ContactPainter.view.ViewSettingsDialog",
					controller: this
		...
		_showDetail : function (oItem) {
            ...
            var sObjId = oItem.getBindingContext("tableData").getPath().split("/");
            var iPath = sObjId[sObjId.length-1];
            console.log(iPath);
