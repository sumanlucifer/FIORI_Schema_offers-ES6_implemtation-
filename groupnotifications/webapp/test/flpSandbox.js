		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#GroupNotifications-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"GroupNotifications-display": {
								"semanticObject": "GroupNotifications",
								"action": "display",
								"description": "App to push notification group wise",
								"title": "Group Notifications",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.knpl.pragati.groupnotifications",
									"url": sap.ui.require.toUrl("com/knpl/pragati/groupnotifications")
								}
							}
						}
					}
