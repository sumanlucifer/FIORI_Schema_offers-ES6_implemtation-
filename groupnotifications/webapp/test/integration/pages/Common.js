sap.ui.define([
	...
	return Opa5.extend("com.knpl.pragati.groupnotifications.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/knpl/pragati/groupnotifications/localService/mockserver"], function (mockserver) {
